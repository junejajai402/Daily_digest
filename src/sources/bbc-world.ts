/**
 * Purpose:
 * This file is a real RSS-backed adapter for BBC World.
 * It fetches the BBC World RSS feed, parses it, and maps the external feed
...
const SOURCE_NAME = "BBC World";
const FEED_URL = "https://feeds.bbci.co.uk/news/world/rss.xml";
const MAX_ITEMS = 8;

export const bbcWorldSource: SourceAdapter = {
  name: SOURCE_NAME,
  async fetchItems() {
